...
$result = "SELECT * FROM despesas_variaveis WHERE id_usuario='$id_usuario' AND MONTH(date_despesa) = MONTH(NOW()) ORDER BY id DESC LIMIT {$pagina}, " . ITENS_POR_PAGINA;
$resulta_conta = mysqli_query($conn, $result);

$quantidade_sql = "SELECT COUNT(*) FROM despesas_variaveis WHERE id_usuario='$id_usuario' AND MONTH(date_despesa) = MONTH(NOW())";
...
<body>
  ...
  <a href="../despesas_fixas/" style="width:50%; border-bottom-right-radius: 20px;"class="tablink vf tab-despesa">Despesas Fixas</a>
  <a href="" style="width:50%;color: #000; background-color: #DDD; font-weight: bold;" class="tablink vf">Despesas Variáveis</a>
    ...
    <thead class="thead-dark">
      ...
      <?php 
        ...
        ?>
            ...
            <tr>
              <th colspan="7" style="color: #F55">Sem despesas variáveis cadastradas no mês atual.</th>
            </tr>
...
?>
  ...
  <form action="../php/add_despesas_variaveis.php" method="POST" style="width: 100%;background-color: white;margin: 0 auto;margin-top:2%;">
    <table class="table table-dark table-bordered">
      ...
      <tr>
          <td><input name="data" required maxlength="10" type="text" onkeypress="mascaraData(this)" id="data" style="width:100%; margin-top: 3px;border: 3px;"></input></td>
          ...
          <td><input name="valor" required id="valor" style="width:100%; margin-top: 3px;border: 3px;"></input></td>
