<?php
  ...
  $result = "SELECT * FROM despesas_variaveis WHERE MONTH(date_despesa) = MONTH(NOW()) ORDER BY id DESC LIMIT {$pagina}, ".ITENS_POR_PAGINA;
  $resulta_conta = mysqli_query($conn, $result); 

  $quantidade_sql = "SELECT COUNT(*) FROM despesas_variaveis WHERE MONTH(date_despesa) = MONTH(NOW())";
